...
**🐧 Primary:** CachyOS (Arch‑based) – main development and daily‑driver OS  
**🎮 Gaming:** Windows 11 Pro – gaming sessions and Windows‑only tools  
**🍎 Experience:** macOS – previously used as a primary system
...
**🎮 Игры:** Windows 11 Pro — игровая система и запуск Win‑инструментов  
**🍎 Опыт:** macOS — ранее использовалась как основная рабочая система
...
![RAM](https://img.shields.io/badge/RAM-Corsair_16GB_DDR4_3200MHz-00BFFF?style=for-the-badge&logo=corsair&logoColor=white)

![SSD](https://img.shields.io/badge/SSD-Samsung_980_EVO_2TB_M.2-1428A0?style=for-the-badge&logo=samsung&logoColor=white)
![HDD](https://img.shields.io/badge/HDD-WD_Blue_1TB_SATA3-0071C5?style=for-the-badge&logo=westerndigital&logoColor=white)
...
![Keyboard](https://img.shields.io/badge/Keyboard-Logitech_G715_TKL-00BFFF?style=for-the-badge&logo=logitech&logoColor=white)
![Mouse](https://img.shields.io/badge/Mouse-Logitech_G_Pro_X_Superlight-00BFFF?style=for-the-badge&logo=logitech&logoColor=white)
...
- **Игровое кресло:** Cougar Armor One V2  
...
- **🇯🇵 Японский:** Обучался в онлайн‑школе, сдан JLPT N5  
...
<details>
<summary><b>Editors (EN)</b></summary>
...
<details>
<summary><b>Редакторы (RU)</b></summary>

<br />

- **VS Code** — основной редактор на Windows и macOS  
- **VSCodium** — основной редактор на Linux (CachyOS)  
- **Neovim + LazyVim** — терминальный стек, настроенный под быструю разработку  
...
- **Python** (`ms-python.python`) — Python support: linting, debugging, IntelliSense  
- **Pylance** (`ms-python.vscode-pylance`) — fast language server with type checking  
- **Python Debugger** (`ms-python.debugpy`) — debugging tools  
- **Python Environments** (`ms-python.vscode-python-envs`) — virtual env manager  
...
- **GitHub Actions** (`github.vscode-github-actions`) — CI/CD workflows  
...
- **SQLTools** (`mtxr.sqltools`) — connections to PostgreSQL / MySQL / SQLite etc.  
...
- **Discord Tools** (`darkempire78.discord-tools`)  
- **vscord** (`leonardssh.vscord`) — Discord Rich Presence  
- **Discord.py Snippets** (`wasimaster.discord-py-snippets`)  
- **Discord VSCode** (`icrawl.discord-vscode`)  
...
- **Russian Language Pack** (`ms-ceintl.vscode-language-pack-ru`) — Russian UI  
...
- 💳 Payment integration (SBP, YooKassa, Stripe)  
...
<details>
<summary><b>Описание проектов (RU)</b></summary>

<br />

- **Faceit AI Bot:** платформа аналитики CS2 c продакшн‑деплоем, оплатами и AI‑анализом  
- **Multimodal Gaming AI Chat:** мультимодальный AI‑чат для геймеров  
- **Stream AI Bot:** автоматизация стримов на Twitch / YouTube  
- **Telegram Forward Bot:** гибкий форвардинг сообщений в Telegram  
- **Aegnux:** улучшенный форк для запуска Adobe After Effects на Linux  
...
<details>
<summary><b>EN / RU</b></summary>

<br />

- **🔷 Go:** high‑performance microservices / высокопроизводительные микросервисы  
- **☸️ Kubernetes:** container orchestration / оркестрация контейнеров  
- **📊 GraphQL:** modern API design / современный подход к API  
...
[![GitHub](https://img.shields.io/badge/GitHub-pat1one-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/pat1one)
